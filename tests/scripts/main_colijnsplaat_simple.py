...
# Add database
database = os.path.join(datadir, 'databases', 'WBI2023_Oosterschelde_28-1_v00_selectie.sqlite')
harbor.hydraulic_loads.add_HRD(database)
supportlocation = 'OS_1_28-1_dk00102'
...
shutil.copy2(os.path.join(datadir, 'databases', 'WBI2023_Oosterschelde_28-1_v00_selectie.sqlite'), os.path.join(tempdir, case))
...
harbor.export.export_dataframe['SQLite-database'] = os.path.join(tempdir, case, 'WBI2023_Oosterschelde_28-1_v00_selectie.sqlite')
