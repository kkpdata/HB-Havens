...
Please note that the selected steunpuntlocatie is far from the project area to the north. As such, it will not be visible in the overview unless the user extends the view far beyond Urk harbour.
