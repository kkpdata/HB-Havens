...
# Add database
database = os.path.join(datadir, 'databases', 'WBI2017_IJsselmeer_8-4_v02_steunpunt.sqlite')
harbor.hydraulic_loads.add_HRD(database)
supportlocation = 'KM_2_8-4_dk_00062'
...
shutil.copy2(os.path.join(datadir, 'databases', 'WBI2017_IJsselmeer_8-4_v02_steunpunt.sqlite'), os.path.join(tempdir, case))
shutil.copy2(os.path.join(datadir, 'databases', 'WBI2017_IJsselmeer_8-4_v02_steunpunt.config.sqlite'), os.path.join(tempdir, case))
...
harbor.export.export_dataframe['SQLite-database'] = os.path.join(tempdir, case, 'WBI2017_IJsselmeer_8-4_v02_steunpunt.sqlite')
